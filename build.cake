...
Task("restore")
    ...
    .Does(() =>
{
    DotNetRestore("./exceldna-abstractions.sln", new DotNetRestoreSettings
    {
        LockedMode = true,
    });
});
...
{
    DotNetBuild("./exceldna-abstractions.sln", new DotNetBuildSettings
    {
    ...
    .DoesForEach(new[] { "ExcelDna.Abstractions", "ExcelDna.IntelliSense.Abstractions", "ExcelDna.Registration.Abstractions" }, (projectName) =>
{
    ...
    DotNetPack($"./src/{projectName}/{projectName}.csproj", new DotNetPackSettings
    {
        Configuration = "Release",
        NoRestore = true,
        NoBuild = true,
